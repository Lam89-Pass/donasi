      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          <div className="flex flex-col">
            <a href="/" className="font-black text-3xl tracking-tight flex items-center gap-1 mb-6 group w-fit">
              ...
              <span className="bg-ramadhan-green text-white px-2.5 py-0.5 rounded-lg font-bold text-sm shadow-sm group-hover:scale-105 transition-transform">Donasi</span>
            </a>
            ...
            <div className="flex items-start gap-3 text-sm text-gray-400 mb-6 border-b border-gray-800/60 pb-6">
              ...
              <p className="leading-relaxed text-xs">Jl. Setiabudhi No. 193, Gegerkalong, Kota Bandung, Jawa Barat</p>
            </div>
            ...
            <div className="flex items-center gap-4">
              {["facebook", "twitter", "instagram", "youtube"].map((social, idx) => (
                <a
                  ...
                  href="#"
                  aria-label={social}
                  className="w-10 h-10 rounded-full bg-gray-800/50 border border-gray-700 flex items-center justify-center text-gray-400 hover:bg-ramadhan-green hover:text-white hover:border-ramadhan-green hover:-translate-y-1 transition-all duration-300 shadow-sm"
                >
                  {social === "facebook" && (
          ...
          <div className="md:pl-12">
            ...
            <ul className="space-y-3.5">
              {["Beranda", "Tentang Kami", "Program Donasi", "Berita", "FAQ"].map((link) => (
                <li key={link}>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm font-medium">
            &copy; {new Date().getFullYear()} <span className="text-gray-400">RuangDonasi</span>. Seluruh hak cipta dilindungi.
          </p>
